...
public class NewShopActivity extends Activity implements ChoiceCategoryListener, ChoiceNameListener, choiceDateListenerInterface {
    ...
    private void init() {
        ...
        mCategoryView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                OutDB db = new OutDB(NewShopActivity.this);
                ArrayList<Category> categoryList = db.getShopCategory();

                ChoiceCategoryDialog categoryDialog = new ChoiceCategoryDialog(NewShopActivity.this, R.string.add_category, mCategoryTextView.getText().toString(), categoryList, NewShopActivity.this, true);
                categoryDialog.show();
            }
        });
        ...
        mNameView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (-1 != mOwn) {
                    ...
                    ChoiceNameDialog nameDialog = new ChoiceNameDialog(R.string.shop_choice, R.string.add_shop, NewShopActivity.this, mNameTextView.getText().toString(), mOwn, nameList, NewShopActivity.this, true);
                    nameDialog.show();
                }
                else {
                    Toast.makeText(NewShopActivity.this, NewShopActivity.this.getString(R.string.info_choice_category_first), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mDateView.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                ChoiceDateDialog dialog = new ChoiceDateDialog(NewShopActivity.this, mTime, NewShopActivity.this);
                dialog.show();
        ...
        mConfirmButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (null == category || category.length() == 0 || false == mHasChoiceCategory) {
                    Toast.makeText(NewShopActivity.this, NewShopActivity.this.getString(R.string.info_can_not_empty_category), Toast.LENGTH_SHORT).show();
                }
                else if (null == name || name.length() == 0 || false == mHasChoiceName) {
                    Toast.makeText(NewShopActivity.this, NewShopActivity.this.getString(R.string.info_can_not_empty_name), Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(NewShopActivity.this, DetailActivity.class);
